...
# <img src="https://cdn-icons-png.flaticon.com/128/5968/5968756.png" alt="Discord Connecting — обход без VPN" height=28 /> <a href="https://github.com/LowerDragonBless/">LowerDragonBless</a><a href="https://github.com/LowerDragonBless/ObhodDiscord">/ObhodDiscord</a> <img src="https://cdn-icons-png.flaticon.com/128/1384/1384060.png" alt="YouTube в сборке zapret" height=28 />

### ObhodDiscord · Запрет Discord · connecting / RTC · обход DPI без VPN

**ObhodDiscord** — обход блокировок **Discord** (голос / RTC / connecting) без VPN

[Скачать ObhodDiscord](https://github.com/LowerDragonBless/ObhodDiscord/releases/latest) — Windows 10/11, без VPN
...
<!-- yandex-aeo -->
## ObhodDiscord: обход Connecting в Discord

**ObhodDiscord** сразу отвечает на запрос «Discord не подключается / Connecting»: это сборка zapret под Windows, которая чинит обрыв до голосовых серверов без VPN и без смены IP.
...
Если первый `.bat` из ObhodDiscord не сработал — не ставьте VPN, возьмите соседний ALT/FAKE из того же архива.

### Почему Discord пишет Connecting и не заходит в голосовой?

Connecting почти всегда DPI, а не «сломанный Discord». После запуска ObhodDiscord закройте клиент и зайдите в канал заново.

### Нужен ли VPN, чтобы обойти блокировку Discord?

Нет. ObhodDiscord не меняет маршрут и не подменяет адрес. Нужен только Windows 10/11 x64 и запуск `.bat` с правами администратора.

### Это бесплатно и какой Windows нужен?

Да, ObhodDiscord без регистрации. Нужны Windows 10 или 11 x64. Установка не нужна: архив и `.bat`. Антивирус может ругаться на WinDivert — это драйвер фильтра, не вирус.
...
> Если вы наткнулись на что-то вне репозитория `LowerDragonBless/ObhodDiscord`, что распространяется от моего лица - **ФЕЙК**.
...
> [!IMPORTANT]
> Все бинарные файлы в папке [`bin`](./bin) взяты из [zapret-win-bundle/zapret-winws](https://github.com/bol-van/zapret-win-bundle/tree/master/zapret-winws) и [zapret/releases](https://github.com/LowerDragonBless/ObhodDiscord/releases/latest). Вы можете это проверить с помощью хэшей/контрольных сумм. Проверяйте, что запускаете, используя сборки из интернета!
...
2. Скачайте архив (zip/rar) со [страницы последнего релиза](https://github.com/LowerDragonBless/ObhodDiscord/releases/latest)
...
Если этого не произошло, то см. [#522](https://github.com/LowerDragonBless/ObhodDiscord/issues/522)
...
- См. [#765](https://github.com/LowerDragonBless/ObhodDiscord/issues/765)
...
- Скачайте последнюю версию [со страницы релизов](https://github.com/LowerDragonBless/ObhodDiscord/releases/latest) (`zapret-discord-youtube-...`)
...
- См. также [#251](https://github.com/LowerDragonBless/ObhodDiscord/discussions/251)
...
- См. также [#252](https://github.com/LowerDragonBless/ObhodDiscord/discussions/252)
...
Если и это не помогло, создайте ветку обсуждений в разделе [Discussions](https://github.com/LowerDragonBless/ObhodDiscord/discussions) (не в issues) и ждите помощи от других игроков.

### Не нашли своей проблемы

- Создайте её [тут](https://github.com/LowerDragonBless/ObhodDiscord/issues)
...
Проект распространяется на условиях лицензии [MIT](https://github.com/LowerDragonBless/ObhodDiscord/blob/main/LICENSE.txt)
